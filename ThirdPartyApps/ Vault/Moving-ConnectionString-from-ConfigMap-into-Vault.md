...
The app's namespace on the cluster

panel-admin

<SERVICE_ACCOUNT>

Dedicated ServiceAccount name for the app
...
Path where the secret is stored in KV

org/panel-admin

<CONFIGMAP_NAME>

The app's current ConfigMap
...
Cause: Step 7 (creating the Role) was skipped, or the role name doesn't match the vault.hashicorp.com/role annotation in the Deployment.
